...
const ExpeditionData = [
  {
    route: "8000m",
    intro:
      "Explore the pinnacle of adventure with our expeditions to the world's highest 8000-meter peaks. These majestic summits, including Mount Everest, Kanchenjunga, Lhotse, and Makalu, offer a monumental challenge and awe-inspiring beauty, demanding elite mountaineering skills and careful planning.",
    id: 1,
    name: "8000m",
  ...
  },
  {
    route: "7000m",
    intro:
      "Conquer the majestic 7000-meter peaks and experience unparalleled alpine challenges. Peaks like Ama Dablam, Baruntse, and Pumori offer climbers the thrill of technical ascents, breathtaking scenery, and a perfect blend of adventure and challenge.",
    id: 2,
    name: "7000m",
  ...
  },
  {
    route: "6000m",
    intro:
      "Embark on thrilling adventures to the stunning 6000-meter peaks, perfect for aspiring mountaineers. Peaks like Island Peak (Imja Tse), Mera Peak, and Lobuche East offer accessible challenges and a gateway to the high-altitude Himalayas.",
    id: 3,
    name: "6000m",
  ...
  },
  {
    route: "5000m",
    intro:
      "Discover the beauty and excitement of 5000-meter peaks, ideal for high-altitude trekking and climbing. Peaks such as Gokyo Ri, Kala Patthar, and Thorong La provide accessible adventures with stunning views of the Himalayan giants.",
    id: 4,
    name: "5000m",
    desc: "Summit Mt. Annapurna for stunning vistas and an epic adventure.",
    days: 16,
